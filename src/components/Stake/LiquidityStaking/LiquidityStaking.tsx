...
export const LiquidityStaking: React.FC<ILiquidityStaking> = ({
  ...
  return (
    <Grid container className={classes.wrapper}>
      ...
      {stakedTokenSupply && <Typography>stakedTokenSupply: {stakedTokenSupply.toString()}</Typography>}
      {stakedAmount && <Typography>stakedAmount: {stakedAmount.toString()}</Typography>}
      <TransactionDetails
