...
export const Swap: React.FC<ISwap> = ({
  ...
  useEffect(() => {
    if (tokenFromIndex !== null && tokenToIndex !== null) {
      if (inputRef === inputTarget.FROM) {
        ...
        console.log("tokens[tokenToIndex]", tokens[tokenToIndex])
  ...
  const setSimulateAmount = async () => {
    ...
    if (tokenFromIndex !== null && tokenToIndex !== null && !swapIsLoading) {
      if (inputRef === inputTarget.FROM) {
        ...
        console.log("data simulasi ini", {
          market: market,
          "tokens[tokenFromIndex].assetAddress": tokens[tokenFromIndex].assetAddress,
          "tokens[tokenToIndex].assetAddress": tokens[tokenToIndex].assetAddress,
          "convertBalanceToBN(amountFrom, tokens[tokenFromIndex].decimals)": convertBalanceToBN(amountFrom, tokens[tokenFromIndex].decimals),
          "true": true,
          swapAccounts: swapAccounts
        })

        console.log("simulateValue FROM", simulateValue)
        console.log("simulateValue FROM", (printBN(simulateWithHopValue.simulation?.totalAmountOut, 11)).toString())
        console.log("simulateWithHopValue FROM", simulateWithHopValue)
        ...
        console.log("simulateValue TO", simulateValue)
        console.log("simulateWithHopValue TO", simulateWithHopValue)
  ...
  const updateSimulation = (
    ...
    if (useTwoHop && simulateWithHopResult.simulation && simulateWithHopResult.route) {
      ...
      console.log("simulateWithHopResult", simulateWithHopResult)
      console.log("simulateWithHopResult.simulation?.swapHopTwo.accumulatedAmountOut.toString()", simulateWithHopResult.simulation?.swapHopTwo.accumulatedAmountOut.toString())
      console.log("AMOUNT OUT DATA:", simulateWithHopResult.simulation?.swapHopTwo.accumulatedAmountOut.toString())
