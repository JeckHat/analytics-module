  ...
  return (
    <Grid container className={classes.wrapper}>
      ...
      <Box className={classes.statsContainer}>
        ...
        />
        {/* <Box className={classes.statsContainer}> */}
        <Typography className={classes.statsTitle}>Earnings forecast
          {estimated24Yield}
          {"   |    "}
          {printBN(sBitzBalance, sBITZ_MAIN.decimals).toString()}
          {"   |    "}
          {printBN(stakedBitzData.bitzTotalBalance, BITZ_MAIN.decimals).toString()}
        </Typography>
        <StakeChart
